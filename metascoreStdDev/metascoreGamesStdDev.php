...
$mainURL = "http://www.metacritic.com/browse/games/score/metascore/year/all/filtered?sort=desc&year_selected=2016";
...
echo "<h2>Games from <a href=$mainURL>2016</a><br>Sorted by Metascore Standard Deviation:</h2>";

echo "<table border=0>";

foreach( $games as $game ) {
    echo "<tr><td class=row_table>";
    printGameLine( $game->url, $game->title, $game->platform,
...
function printGameLine( $inURL, $inTitle, $inPlatform, $inMetaScore, $inDev ) {
