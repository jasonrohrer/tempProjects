...
//
// This version has players make both choices in one turn
class MagicSquareGameStateTwoPick : public GameState {
    public:
        
        // blank, no init done
        MagicSquareGameStateTwoPick();
        
        // square copied internally
        // inits to no moves made yet
        MagicSquareGameStateTwoPick( int *inStartingState );
        ...
        GameState *makeMove( int inPlayerNumber, int inColumnOrRowUs );
