...
// wrapper that takes a base-32 encoded secret key and returns a 6-digit
// OTP
function generateTokenSimple( $base32EncodedKey ) {
    $key = Base32::decode( $base32EncodedKey );

    $instance = new Totp();
    
    return $instance->GenerateToken( $key );
    }
