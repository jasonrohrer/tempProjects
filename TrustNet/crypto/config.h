 ...
 * Added include of debugMemory.
 *
 * 2002-October-19   Jason Rohrer
 * Removed use of Intel Intrinsics.
 *
 * 2002-October-20   Jason Rohrer
 * Fixed include order so that it will compile with debugMemory.
 *
 * 2002-October-24   Jason Rohrer
 * Fixed include order again so that debugMemory will work with
 * visual c++.
 */
